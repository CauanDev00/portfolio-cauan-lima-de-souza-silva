  ...
  if (settings.mode === 'multi') {
    return (
      <div className="w-full p-4">
        ...
        <div id="qr-plate-capture" className="relative bg-[#F7F7F7] rounded-[24px] p-8 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-slate-100 overflow-visible">
